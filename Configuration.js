...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("TC_DM_add1", "Contenedor1", endpointType.textContainer);
  var vtxt = endpoints.addEndpoint("ep2", "Texto", endpointType.TextContainer);
  gfs.variableTypeId = 1038;}
